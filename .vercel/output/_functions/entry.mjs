...
import { manifest } from './manifest_D4OZv_6g.mjs';
...
const _page6 = () => import('./pages/api/player-summaries.astro.mjs');
const _page7 = () => import('./pages/api/player-summary.astro.mjs');
const _page8 = () => import('./pages/api/resolve.astro.mjs');
const _page9 = () => import('./pages/api/search.astro.mjs');
const _page10 = () => import('./pages/game/_key_.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/api/player-summaries.ts", _page6],
    ["src/pages/api/player-summary.ts", _page7],
    ["src/pages/api/resolve.ts", _page8],
    ["src/pages/api/search.ts", _page9],
    ["src/pages/game/[key].astro", _page10],
...
const _args = {
    "middlewareSecret": "b6736312-61ed-493d-8c3d-33256ed70acb",
