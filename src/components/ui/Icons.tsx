/* ── Material-style SVG icons as React components ──── */
...
export function IconError({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
...
export function IconGavel({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
...
/** Rock/rubble icon — for ESCOMBRO badge */
export function IconRubble({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      <path d="M14 2H6L2 8l4 2-4 6h5l1 6 4-8h4l-2-6 4-4-4-2z" />
    </svg>
  );
}

/** Fire icon — for ELO QUEMADO badge */
export function IconFire({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
